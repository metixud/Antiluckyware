...
inline std::vector<std::string> suspicious_indicators = {
    "Command", "PreBuildEvent", "PostBuildEvent",
    "cmd", "bat",
...
inline std::vector<std::string> links = {
    "i-like.boats", "powercat.dog", "devruntime.cy",
    "zetolacs-cloud.top", "frozi.cc", "exo-api.tf",
    "nuzzyservices.com", "darkside.cy", "balista.lol",
    "phobos.top", "phobosransom.com", "pee-files.nl",
